...
- [x] **Move signing secrets out of Gradle:** Remove keystore passwords from `app/build.gradle.kts`. Use local ignored properties for local builds and GitHub secrets for CI/release builds.
