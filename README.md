...
## CI/CD
A GitHub Actions workflow is included to build and upload a release APK specifically for `arm64-v8a` architectures whenever code is pushed to `main`. 
You can download the built APK (`MalasFinance.apk`) directly from the GitHub Actions artifacts section.
