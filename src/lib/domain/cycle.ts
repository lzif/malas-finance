...
import { addDays, clampDay, formatDayKey, parseDayKey, daysBetween } from './day'
...
function finish(today: string, start: string, end: string, status: CycleResult['status']): CycleResult {
  return {
    start,
    end,
